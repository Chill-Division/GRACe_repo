...
if (!defined('GRACE_ASSET_VERSION')) {
    define('GRACE_ASSET_VERSION', '1.0.1');
}
...
<head>
    ...
    <script>
        ...
        // wrong theme. Light is the default; the sun/moon toggle saves the
        // user's choice in localStorage and that always wins.
        (function () {
            try {
                var theme = localStorage.getItem('grace-theme') === 'dark' ? 'dark' : 'light';
                document.documentElement.setAttribute('data-theme', theme);
            } catch (e) { /* stay on the default light theme */ }
        })();
    </script>
