                ...
                files.forEach(file => {
                    ...
                    fileListBody.append(`
                        <tr ${rowClass}>
                            ...
                            ${expiryCell}
                            <td><a href="download.php?category=${category}&file=${encodeURIComponent(file.unique_filename)}" download="${escapeHtml(file.original_filename)}">${downloadIcon} Download</a></td>
                            ${actionCell}
                        </tr>
                    `);
                });
