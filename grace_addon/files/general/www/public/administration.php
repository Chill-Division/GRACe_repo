    ...
    <main class="container">
        ...
        <section class="hub-section">
            ...
            <div class="card-grid">
                ...
                <a class="nav-card" href="verified_companies.php">
                    ...
                    <span class="nav-card-body">
                        <strong>Edit Verified Companies</strong>
                        <small>View your verified companies and update license numbers, addresses, or contact details</small>
                    </span>
                </a>
            </div>
        </section>
        ...
        <section class="hub-section">
            ...
            <div class="card-grid">
                ...
                <a class="nav-card" href="whats_new.php">
                    ...
                    <span class="nav-card-body">
                        ...
                        <small>What changed in the latest update, if you missed the pop-up</small>
                    </span>
                </a>
