...
### 13. Annual Stocktake Logic (`tests/test_annual_stocktake.php`)
...
### 14. NZ Time (`tests/test_nz_time.php`)
...
### 15. Agency Report Reminders (`tests/test_report_reminders.php`)
...
### 16. Monthly Report Periods (`tests/test_report_periods.php`)
...
### 17. Company Adding (`tests/test_company_adding.php`)
...
### 18. Company Editing (`tests/test_company_editing.php`)
...
### 19. Own Company Details (`tests/test_own_company.php`)
...
### 20. License Alerts (`tests/test_license_alerts.php`)
...
### 21. License Expiry Limit (`tests/test_license_expiry.php`)
...
### 22. Download Filenames (`tests/test_download_names.php`)
...
### 23. Static Code Analysis (`tests/static_checks.sh`)
*   **Critical Paths:**
...
### 24. Version Consistency (`tests/test_version_consistency.php`)
*   **Why:** Ensures the version number is identical across:
    *   `config.yaml` (Home Assistant)
    *   `nav.php` (UI Display)
    *   `CHANGELOG.md` (Release Notes)

### 25. PHP Syntax Check (`tests/syntax_check.sh`)
