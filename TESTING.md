...
### 15. NZ Time (`tests/test_nz_time.php`)
...
### 16. Agency Report Reminders (`tests/test_report_reminders.php`)
...
### 17. Monthly Report Periods (`tests/test_report_periods.php`)
...
### 18. Company Adding (`tests/test_company_adding.php`)
...
### 19. Company Editing (`tests/test_company_editing.php`)
...
### 20. Own Company Details (`tests/test_own_company.php`)
...
### 21. License Alerts (`tests/test_license_alerts.php`)
...
### 22. License Expiry Limit (`tests/test_license_expiry.php`)
...
### 23. Download Filenames (`tests/test_download_names.php`)
...
### 24. Static Code Analysis (`tests/static_checks.sh`)
*   **Critical Paths:**
...
### 25. Version Consistency (`tests/test_version_consistency.php`)
*   **Why:** Ensures the version number is identical across:
    *   `config.yaml` (Home Assistant)
    *   `nav.php` (UI Display)
    *   `CHANGELOG.md` (Release Notes)

### 26. PHP Syntax Check (`tests/syntax_check.sh`)
