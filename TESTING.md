...
### 4. Permission Logic (`tests/test_permissions.php`)
...
### 5. Harvest Safeguards (`tests/test_harvest_safeguards.php`)
...
### 6. Annual Stocktake Logic (`tests/test_annual_stocktake.php`)
...
### 7. NZ Time (`tests/test_nz_time.php`)
...
### 8. Agency Report Reminders (`tests/test_report_reminders.php`)
...
### 9. Monthly Report Periods (`tests/test_report_periods.php`)
...
### 10. Company Editing (`tests/test_company_editing.php`)
...
### 11. Own Company Details (`tests/test_own_company.php`)
...
### 12. License Alerts (`tests/test_license_alerts.php`)
...
### 13. License Expiry Limit (`tests/test_license_expiry.php`)
...
### 14. Download Filenames (`tests/test_download_names.php`)
...
### 15. Static Code Analysis (`tests/static_checks.sh`)
*   **Critical Paths:**
...
### 16. Version Consistency (`tests/test_version_consistency.php`)
*   **Why:** Ensures the version number is identical across:
    *   `config.yaml` (Home Assistant)
    *   `nav.php` (UI Display)
    *   `CHANGELOG.md` (Release Notes)

### 17. PHP Syntax Check (`tests/syntax_check.sh`)
