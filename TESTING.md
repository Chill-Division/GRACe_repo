...
### 5. Agency Report Reminders (`tests/test_report_reminders.php`)
...
*   `tests/seed_demo_data.php [--force] [--legacy]` fills a dev database with realistic content (plants, ledger entries, companies, documents, manifests). `--legacy` shapes it like a 1.0.x install so you can watch the 1.1 upgrade run on the next page load. See DEVELOPMENT.md.
